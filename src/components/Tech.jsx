            ...
            <div className="row bgg">
                <div className="col-md-10  mx-auto  m-4">
                    <div className="row w-auto svgwdth   d-flex   justify-content-center">
                        <div className="col-md-2  border border-3">
                            <div className="row align-items-center justify-content-center p-3 border border-3-bottom">
                                <i style={{ width: "100px" }} >
                        ...
                        <div className="col-md-2 d-flex align-items-center border border-3  ">
                            <div className="row align-items-center justify-content-center p-3">
                                <i style={{ width: "100px" }} >
                        ...
                        <div className="col-md-2 border border-3  d-flex align-items-center ">
